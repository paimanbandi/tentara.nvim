...
theme.load_syntax = function()
	...
	local syntax = {
		...
		Function = { c.cTenne, nil, 'none', nil}, -- function name
		...
		Type = { c.cJapaneseLaurel, nil, 'none', nil}, -- class name, data type
		StorageClass = { c.cPictonBlue, nil, 'none', nil}, -- class, final, extends, const, let, var
